...
iface = '0.0.0.0'
# Note: for ports < 1024 the server script must be ran as root.
port = 8080
# END of CONFIG
            ...
            for param in spl:
                ...
                if gpioacl[a][0] == OUT:
                    if b <= 0:
                        ...
                        self.res(
                            f'<li><a href="?{par.replace(param, param[:-1] + "1")}"><div class="control-on">GPIO {a}: <span class="green">ON</span></div></a></li>')
                    else:
